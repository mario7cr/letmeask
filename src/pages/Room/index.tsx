...
export function Room() {
  ...
  async function handleLikeQuestion(
    ...
    const databasePath = `rooms/${roomId}/questions/${questionId}/likes${
      likeId ? "/" + likeId : ""
    }`
    const roomRef = ref(database, databasePath)

    await (likeId ? remove(roomRef) : push(roomRef, { authorId: user?.id }))
  }
